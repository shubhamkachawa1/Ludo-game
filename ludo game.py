        ...
        if i.type == pygame.QUIT:
            pygame.quit()
                    ...
                    if(red_flage==True and dice_run==True):
                        if (red_a_goti_rect).collidepoint(i.pos):
                            goti_run("red_a",dice_number)
                            red_flage=False
                            green_flage=True
                            
                        elif (red_b_goti_rect).collidepoint(i.pos):
                            goti_run("red_b",dice_number)
                            red_flage=False
                            green_flage=True
                        elif (red_c_goti_rect).collidepoint(i.pos):
                            goti_run("red_c",dice_number)
                            red_flage=False
                            green_flage=True
                        elif (red_d_goti_rect).collidepoint(i.pos):
                    ...
                    if(green_flage==True and dice_run==True):
                        if (green_a_goti_rect).collidepoint(i.pos):
                            goti_run("green_a",dice_number)
                            red_flage=True
                            green_flage=False
                        elif (green_b_goti_rect).collidepoint(i.pos):
                            goti_run("green_b",dice_number)
                            red_flage=True
                            green_flage=False
                        elif (green_c_goti_rect).collidepoint(i.pos):
                            goti_run("green_c",dice_number)
                            red_flage=True
                            green_flage=False
                        elif (green_d_goti_rect).collidepoint(i.pos):
